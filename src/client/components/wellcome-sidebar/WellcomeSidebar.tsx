...
const WelcomeSidebar = () => {
  ...
  const links = [
    ...
    { id: 2, to: "/help", text: t("sidebar.links.help"), icon: "icon-wondering" },
    { id: 3, to: "/about", text: t("sidebar.links.about"), icon: "icon-information" },
    { id: 4, to: "/privacy", text: t("sidebar.links.privacy"), icon: "icon-privacy_tip" },
    { id: 5, to: "/feedback", text: t("sidebar.links.feedback"), icon: "icon-bubble" }
  ];
